...
if input("Testbot or Serendipity? (T or S) ").lower() == "t":
	bot.run("ODY5NDE2NzI2MjA5NjU4OTEw.GvyptA.V5SslqC-VxQScM49r_ZU5L6s_kVDPBvz8sJVhw")
else:
	bot.run("MTAyODQxOTI0OTMzMDQ2Mjc4MA.GmCaCx.cR3vMpZPe5SMXxlCQxiW7CJqLUKphPnjAc-T1I")